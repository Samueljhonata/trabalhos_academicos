...
public class ControlaComandosSistema {
    ...
    public boolean recebeComando(String sql, Usuario usuario){
        ...
        if(s.contains("CREATE USER")){ //criar usuario
            ...
            System.out.println("CLASSE:" + classeSeguranca);
            ...
            if (classeSeguranca.getNum() <= usuario.getClasseSeguranca().getNum()) { 
                novo = controlaUsuario.insereUsuario(nomeUsuario, senha, classeSeguranca);
                if (novo != null) {
                    return true;
                }
            }else{
        ...
        if(s.contains("DROP USER")){ //excluir usuario
            ...
            String[] a = sql.split(" ");
            nomeUsuario = a[2];
            Usuario usuarioRemover = controlaUsuario.pesquisaUsuarioNome(nomeUsuario);
            ...
            if (usuarioRemover.getClasseSeguranca().getNum() <= usuario.getClasseSeguranca().getNum()) {
                ...
                return (controlaUsuario.removeUsuario(nomeUsuario));
            }else{
        ...
        if(s.contains("SET PASSWORD FOR")){ //alterar senha usuario
            ...
            Usuario usuarioEditar = controlaUsuario.pesquisaUsuarioNome(nomeUsuario);
            ...
            if (usuarioEditar.getClasseSeguranca().getNum() <= usuario.getClasseSeguranca().getNum()) {
                ...
                if (controlaUsuario.atualizaSenhaUsuario(nomeUsuario, senha) != null){
                    return true;
                }
                return false;
            }else{
        ...
        if(s.contains("SET CLASS FOR")){ //alterar classe de segurança do usuario
            ...
            if (usuarioEditar.getClasseSeguranca().getNum() <= usuario.getClasseSeguranca().getNum()) {
                ...
                if (controlaUsuario.atualizaUsuario(nomeUsuario, usuarioEditar.getSenha(), ClasseSeguranca.retorna(classe)) != null){
                    return true;
                }
                return false;
            }else{
        ...
        if(s.contains("RENAME USER")){ //alterar nome usuario
            ...
            if (usuarioEditar.getClasseSeguranca().getNum() <= usuario.getClasseSeguranca().getNum()) {
                ...
                if (controlaUsuario.atualizaNomeUsuario(nomeUsuario, novoNome) != null){
                    return true;
                }
                return false;
            }else{
